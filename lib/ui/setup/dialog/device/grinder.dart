...
class GrinderEntryView extends StatefulWidget {
  final DialogRequest request;
  final Function(DialogResponse) onDialogTap;

  const GrinderEntryView({
    Key? key,
  ...
  @override
  State<GrinderEntryView> createState() => _GrinderEntryViewState();
}

class _GrinderEntryViewState extends State<GrinderEntryView> {
