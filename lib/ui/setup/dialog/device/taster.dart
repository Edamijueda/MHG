...
class TasterEntryView extends StatefulWidget {
  final DialogRequest request;
  final Function(DialogResponse) onDialogTap;

  const TasterEntryView({
    Key? key,
  ...
  @override
  State<TasterEntryView> createState() => _TasterEntryViewState();
}

class _TasterEntryViewState extends State<TasterEntryView> {
