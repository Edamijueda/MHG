...
class RollerEntryView extends StatefulWidget {
  final DialogRequest request;
  final Function(DialogResponse) onDialogTap;

  const RollerEntryView({
    Key? key,
  ...
  @override
  State<RollerEntryView> createState() => _RollerEntryViewState();
}

class _RollerEntryViewState extends State<RollerEntryView> {
