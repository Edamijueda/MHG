...
class BubbleEntryView extends StatefulWidget {
  final DialogRequest request;
  final Function(DialogResponse) onDialogTap;

  const BubbleEntryView(
      {Key? key, required this.request, required this.onDialogTap})
      : super(key: key);

  @override
  State<BubbleEntryView> createState() => _BubbleEntryViewState();
}

class _BubbleEntryViewState extends State<BubbleEntryView> {
