...
class GrinderView extends StatefulWidget {
  const GrinderView({Key? key}) : super(key: key);

  @override
  State<GrinderView> createState() => _GrinderViewState();
}

class _GrinderViewState extends State<GrinderView> {
  @override
            ...
            if (model.reactiveGrinder != null) {
              return Expanded(
                child: GridView.count(
                  ...
                  children: model.reactiveGrinder!
                      .map((element) =>
