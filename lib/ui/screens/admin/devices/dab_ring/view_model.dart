...
class DabRingViewModel extends ReactiveViewModel {
  final log = getStackedLogger('DabRingViewModel');
  ...
  List<Device>? get reactiveDabRing => _fireStoreDbService.reactiveDabRing;
  ...
  realtimeOperations() {
    callDabRingRealtimeUpdate();
  }

  void callDabRingRealtimeUpdate() {
    _fireStoreDbService.getDabRingRealtimeUpdate();
  }
}
