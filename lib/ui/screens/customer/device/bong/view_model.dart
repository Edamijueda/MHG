...
class CBongViewModel extends CustomerDeviceViewModel
    implements ReactiveViewModel {
  final log = getStackedLogger('CBongViewModel');
  ...
  List<Device>? get reactiveBong => _userFsService.rBong;
