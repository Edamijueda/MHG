...
class CGrinderViewModel extends CustomerDeviceViewModel
    implements ReactiveViewModel {
  final log = getStackedLogger('CGrinderViewModel');
  ...
  List<Device>? get reactiveGrinder => _userFsService.rGrinder;
  ...
  realtimeOperations() {
    grinderRealtimeUpdate();
  }

  void grinderRealtimeUpdate() {
    _userFsService.grinderRtUpdate();
  }
}
