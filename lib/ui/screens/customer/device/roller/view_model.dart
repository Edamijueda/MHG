...
class CRollerViewModel extends CustomerDeviceViewModel
    implements ReactiveViewModel {
  final log = getStackedLogger('CRollerViewModel');
  ...
  List<Device>? get reactiveRoller => _userFsService.rRoller;
  ...
  realtimeOperations() {
    rollerRealtimeUpdate();
  }

  void rollerRealtimeUpdate() {
    _userFsService.rollerRtUpdate();
  }
}
