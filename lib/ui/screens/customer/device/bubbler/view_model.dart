...
class CBubbleViewModel extends CustomerDeviceViewModel
    implements ReactiveViewModel {
  final log = getStackedLogger('CBubbleViewModel');
  ...
  List<Device>? get reactiveBubble => _userFsService.rBubble;
  ...
  realtimeOperations() {
    bubbleRealtimeUpdate();
  }

  void bubbleRealtimeUpdate() {
    _userFsService.bubbleRtUpdate();
  }
}
