...
class CPipeViewModel extends CustomerDeviceViewModel
    implements ReactiveViewModel {
  final log = getStackedLogger('CPipeViewModel');
  ...
  List<Device>? get reactivePipe => _userFsService.rPipe;
  ...
  void pipeRealtimeUpdate() {
    _userFsService.pipeRtUpdate();
  }
}
